...
public class FirstDisplay implements Runnable { //начачел дисплей, може да се направи абстрактен клас  na game
    private String name;
    ...
    public FirstDisplay(String name, int width, int height) {
        this.name = name;
        this.width = width;
        this.height = height;
    ...
    protected void render() { //визуализираме нещата
        ...
        this.graphics.drawImage(ImageLoader.loadImage("/bngf.jpg"), 0, 0, 800, 600, null);
